...
//import car.car1.UserRepositoryUserDetailsService;
...
//        http
//                .authorizeRequests()
//                .antMatchers("/index", "/orders")
//                .access("hasRole('ROLE_Admin')")
//                .antMatchers("/","/single","/review", "/adduser", "/register").access("permitAll")
...
//end::customUserDetailsService[]
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/index", "/orders")
                .access("hasRole('ROLE_Admin')")
                .antMatchers("/","/single","/review").access("permitAll")
                .antMatchers("/admin","/admin/**").access("hasRole('ROLE_Admin')")
                //end::authorizeRequests[]
